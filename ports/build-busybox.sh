...
for symbol in \
    ...
    NC FEATURE_NC_SERVER WGET FEATURE_WGET_STATUSBAR FEATURE_WGET_LONG_OPTIONS FEATURE_WGET_TIMEOUT \
...
for symbol in \
    ...
    FEATURE_IPV6 PING6 TRACEROUTE TRACEROUTE6 TELNET TELNETD IP FEATURE_UDHCPC_ARPING \
    FEATURE_WGET_HTTPS TLS
do
    set_config "$symbol" n
done
