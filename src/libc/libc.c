...
int t_socket(int d,int t,int p){return (int)t_syscall3(41,d,t,p);} int t_socketpair(int d,int t,int p,int f[2]){return (int)t_syscall4(53,d,t,p,(long)f);} int t_bind(int f,const struct t_sockaddr_un*a,unsigned long n){return (int)t_syscall3(49,f,(long)a,(long)n);} int t_listen(int f,int b){return (int)t_syscall2(50,f,b);} int t_accept(int f){return (int)t_syscall3(43,f,0,0);}
int t_bind_in(int f,const struct t_sockaddr_in*a){return (int)t_syscall3(49,f,(long)a,(long)sizeof(*a));}
int t_connect_in(int f,const struct t_sockaddr_in*a){return (int)t_syscall3(42,f,(long)a,(long)sizeof(*a));}
int t_accept_in(int f,struct t_sockaddr_in*a){unsigned int n=(unsigned int)sizeof(*a);return (int)t_syscall3(43,f,(long)a,a?(long)&n:0);}
int t_shutdown(int f,int h){return (int)t_syscall2(48,f,h);}
int t_mount(const char*s,const char*t,const char*y,unsigned long f,const void*d){return (int)t_syscall5(165,(long)s,(long)t,(long)y,(long)f,(long)d);}
int t_umount2(const char*t,int f){return (int)t_syscall2(166,(long)t,f);} int t_accept4(int f,int flags){return (int)t_syscall4(288,f,0,0,flags);} int t_getsockname(int f,struct t_sockaddr_un*a,unsigned int*n){return (int)t_syscall3(51,f,(long)a,(long)n);} int t_getpeername(int f,struct t_sockaddr_un*a,unsigned int*n){return (int)t_syscall3(52,f,(long)a,(long)n);} int t_connect(int f,const struct t_sockaddr_un*a,unsigned long n){return (int)t_syscall3(42,f,(long)a,(long)n);}
long t_sendmsg(int f,const struct t_msghdr*m,int flags){return t_syscall3(46,f,(long)m,flags);} long t_recvmsg(int f,struct t_msghdr*m,int flags){return t_syscall3(47,f,(long)m,flags);} int t_setsockopt(int f,int l,int o,const void*v,unsigned long n){return (int)t_syscall5(54,f,l,o,(long)v,(long)n);} int t_getsockopt(int f,int l,int o,void*v,unsigned int*n){return (int)t_syscall5(55,f,l,o,(long)v,(long)n);}
int t_pipe(int f[2]){return (int)t_syscall1(22,(long)f);} int t_pipe2(int f[2],int flags){return (int)t_syscall2(293,(long)f,flags);} int t_dup2(int a,int b){return (int)t_syscall2(33,a,b);} int t_dup3(int a,int b,int flags){return (int)t_syscall3(292,a,b,flags);} int t_fcntl(int f,int c,long a){return (int)t_syscall3(72,f,c,a);} long t_fork(void){return t_syscall0(57);}
...
int t_mkdir(const char *p,int m){return (int)t_syscall2(83,(long)p,m);} int t_umask(int m){return (int)t_syscall1(95,m);} int t_unlink(const char *p){return (int)t_syscall1(87,(long)p);} int t_link(const char *e,const char *n){return (int)t_syscall2(86,(long)e,(long)n);} int t_stat(const char *p,struct t_stat *s){return (int)t_syscall2(4,(long)p,(long)s);} long t_getdents64(int f,void *b,size_t n){return t_syscall3(217,f,(long)b,(long)n);}
...
int t_clock_nanosleep(int c,int f,const struct t_timespec*r,struct t_timespec*m){return (int)t_syscall4(230,c,f,(long)r,(long)m);} int t_eventfd(unsigned int v,int f){return (int)t_syscall2(290,v,f);} int t_timerfd_create(int c,int f){return (int)t_syscall2(283,c,f);} int t_timerfd_settime(int d,int f,const struct t_itimerspec*n,struct t_itimerspec*o){return (int)t_syscall4(286,d,f,(long)n,(long)o);} int t_timerfd_gettime(int d,struct t_itimerspec*v){return (int)t_syscall2(287,d,(long)v);} int t_epoll_create1(int f){return (int)t_syscall1(291,f);} int t_epoll_ctl(int e,int o,int f,struct t_epoll_event*v){return (int)t_syscall4(233,e,o,f,(long)v);} int t_epoll_wait(int e,struct t_epoll_event*v,int n,int t){return (int)t_syscall4(232,e,(long)v,n,t);} int t_inotify_init1(int f){return (int)t_syscall1(294,f);} int t_inotify_add_watch(int f,const char*p,uint32_t m){return (int)t_syscall3(254,f,(long)p,m);} int t_inotify_rm_watch(int f,int w){return (int)t_syscall2(255,f,w);}
